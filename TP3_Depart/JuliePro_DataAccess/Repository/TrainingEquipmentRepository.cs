...
{
    public class TrainingEquipmentRepository : Repository<TrainingEquipment>, ITrainingEquipmentRepository
    {
        ...
        public void Update(TrainingEquipment trainingEquipment)
        {
